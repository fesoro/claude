...
MCP serverləri uzaqda (HTTP nəqli) olduqda, 2025-03-26 spesifikasiyası autentifikasiya üçün OAuth 2.0 axını müəyyən edir. Tam həyata keçirilmə üçün `17-mcp-oauth-auth.md` faylına baxın.

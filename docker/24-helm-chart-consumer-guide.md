...
- [kubernetes-helm.md](23-kubernetes-helm.md) — Helm chart authoring
- [kubernetes-basics.md](18-kubernetes-basics.md) — K8s əsasları
- [local-kubernetes-for-backend-dev.md](25-local-kubernetes-for-backend-dev.md) — Local K8s test

...
- `34-slice-advanced` — slice əməliyyatları (Go 1.21 slices paketi)
- `../backend/08-data-structures` — generic tree, queue, heap
- `../advanced/05-reflection` — runtime tip introspection (generics alternativi)

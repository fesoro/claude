...
Go-da email göndərmə `net/smtp` standart paketi ilə mümkündür, lakin production üçün `gopkg.in/gomail.v2` daha praktikdir: HTML/text multipart, attachment, CC/BCC dəstəyi. PHP/Laravel-in `Mail::to()->send()` sisteminin Go ekvivalenti.

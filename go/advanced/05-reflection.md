...
- [10-structs](../core/10-structs.md) — struct əsasları
- [17-interfaces](../core/17-interfaces.md) — interface sistemi
- [20-json-encoding](../core/20-json-encoding.md) — JSON marshal/unmarshal (reflection işlədir)
- [29-generics](../core/29-generics.md) — reflection alternativ kimi generics
- [59-design-patterns](04-design-patterns.md) — framework-lərdə reflection istifadəsi

...
**Premature microservices** — domain hələ aydın olmadan, team kiçik ikən (< 15 nəfər), bounded context-lər müəyyən edilmədən servisləri ayırmaq. Nəticə: distributed monolith yaranır — servislərin hamısı bir-birinə synchronous HTTP ilə bağlıdır, birinin çöküşü hamını çökdürür, deployment ardıcıllıq tələb edir, ACID transaction itirilir. Bu startup-ların ən bahalı arxitektura səhvidir.

**Team-dən əvvəl microservice** — Conway's Law qaçınılmazdır: sistemin arxitekturası komandanın kommunikasiya strukturunu əks etdirir. 3 developer-in yazdığı 10 microservice, real microservice deyil — bir nəfər bütün servisləri dəyişməlidir. Əvvəlcə modular monolith, domain aydınlaşınca team-lər formalaşınca servisləri ayır.

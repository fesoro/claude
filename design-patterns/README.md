...
| [structural/](structural/) | Struktur Pattern-lər (GoF) | 7 | Middle–Lead |
| [behavioral/](behavioral/) | Davranış Pattern-lər (GoF) | 11 | Middle–Lead |
| [laravel/](laravel/) | Laravel-specific Pattern-lər | 14 | Junior–Senior |
| [ddd/](ddd/) | Domain-Driven Design | 9 | Middle–Lead |
| [architecture/](architecture/) | Arxitektura Pattern-lər | 12 | Junior–Lead |
| [integration/](integration/) | İnteqrasiya / Distributed Systems | 18 | Middle–Architect |
| [general/](general/) | Ümumi Pattern-lər | 9 | Middle–Lead |
| **Cəmi** | | **86** | |
...
integration/01-10 → integration/13-18 → general/03 → general/08 → ddd/04-06
...
Repository, Service Layer, Pipeline, Specification, Event-Listener, DI vs Service Locator, Policy Handler, Command/Query Bus, State Machine, Action Class, Form Object, Presenter/ViewModel, Lazy vs Eager Loading, Unit of Work.
...
CQRS, Event Sourcing, Saga, Outbox, 2PC, Strangler Fig, Bulkhead, Anti-Corruption Layer, BFF, API Composition, Choreography vs Orchestration, EIP, ES+CQRS Combined, Read Model Projection, ES Snapshots, Circuit Breaker, Retry Pattern, Throttling/Rate Limiting.

### General
Cross-cutting mövzular — hər yerdə işlənən, düzgün tətbiq edilmədikcə texniki borca çevrilən.
DTO, Code Smells & Refactoring, Concurrency Patterns, Multi-Tenancy, Technical Debt, ADR, Cache-Aside, Caching Strategies, Feature Flags.

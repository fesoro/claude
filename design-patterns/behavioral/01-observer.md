...
- **Anti-Pattern Nə Zaman Olur?**: "Event spaghetti" — hər kiçik dəyişiklik üçün event fire etmək, listener-in başqa event fire etməsi, onun da başqa listener-i tetikləməsi; izlənməsi çətin bir zəncir yaranır. İkinci problem: synchronous listener-lər performansı bloklayır — `UserRegistered` event-inin 5 synchronous listener-i varsa, hər qeydiyyat 5 işin bitməsini gözləyir. Qayda: listener count > 3 olduqda `ShouldQueue` məcburidir; listener başqa event fire edə bilməz.
...
## Əlaqəli Mövzular
- [../laravel/05-event-listener.md](../laravel/05-event-listener.md) — Laravel Event/Listener daha dərindən
- [03-command.md](03-command.md) — Command işi encapsulate edir, Observer onu trigger edir
- [07-state.md](07-state.md) — State dəyişikliyi Observer event-ini trigger etmək üçün istifadə olunur
- [../ddd/05-ddd-domain-events.md](../ddd/05-ddd-domain-events.md) — Domain Events Observer pattern-in DDD tətbiqi

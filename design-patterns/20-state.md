...
## Əlaqəli Mövzular
- [19-chain-of-responsibility.md](19-chain-of-responsibility.md) — State transition zamanı validation chain
- [16-event-listener.md](16-event-listener.md) — State dəyişikliyinə görə event fire etmək
- [09-strategy.md](09-strategy.md) — State vs Strategy: hər ikisi davranışı dəyişir amma fərqli məqsədlə
- [15-service-layer.md](15-service-layer.md) — State transition logic-ini service-ə köçürmək

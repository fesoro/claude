...
## Əlaqəli Mövzular
- [Strategy](07-strategy.md) — fərq: Strategy bir algorithm-u bir context üçün dəyişdirir; Visitor structured hierarchy-yə algorithm əlavə edir
- [Composite](09-composite.md) — Visitor tez-tez Composite structure-u traverse etmək üçün istifadə olunur
- [Iterator](../design-patterns/) — structure traverse etmək üçün alternativ; Visitor-da element öz traversal-ını idarə edir
- [Command](11-command.md) — Visitor-un hər visit metodu command kimi modellenə bilər

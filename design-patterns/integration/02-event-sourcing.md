...
## Əlaqəli Mövzular
- [CQRS](01-cqrs.md) — natural pair: command-lar event store-a yazır, query-lər projection-lardan oxuyur
- [Event Sourcing + CQRS Combined](13-event-sourcing-cqrs-combined.md) — ikisi birlikdə real implementasiya
- [Event Sourcing Snapshots](15-event-sourcing-snapshots.md) — böyük event axını üçün performance optimization
...
- [DDD Aggregates](../ddd/04-ddd-aggregates.md) — domain event-lər DDD aggregate-lərindən raise olunur
- [Domain Events](../ddd/05-ddd-domain-events.md) — event-lərin domain semantikası
- [Hexagonal Architecture](../architecture/05-hexagonal-architecture.md) — event store infrastructure adapter-dır

...
## Əlaqəli Mövzular
- [Adapter](../design-patterns/) — fərq: Adapter uyğunsuzluğu geriyə dönük düzəldir (reactive), Bridge əvvəldən planlanır (proactive)
- [Strategy](07-strategy.md) — Strategy yalnız algorithm dəyişdirir; Bridge-də abstraction tərəfinin öz hierarchy-si var
- [Abstract Factory](03-abstract-factory.md) — factory implementation-ları yarada bilər; Bridge composition üçün
- [Decorator](10-decorator.md) — hər ikisi composition istifadə edir; lakin Decorator responsibility əlavə edir, Bridge separates concerns

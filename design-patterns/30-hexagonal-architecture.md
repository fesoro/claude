...
## Əlaqəli Mövzular
- [DDD Tactical Patterns](26-ddd-patterns.md) — hexagonal architecture DDD ilə birlikdə natural uyğundur; domain entity, aggregate, VO burada yaşayır
- [CQRS](25-cqrs.md) — application layer CQRS ilə tamamlanır; command/query handler-lər use case-lərdir
- [Event Sourcing](29-event-sourcing.md) — event store secondary adapter-dır; domain port vasitəsilə bilir
- [Repository Pattern](../php/topics/) — secondary port; hexagonal-ın əsas adapter növüdür
- [Adapter Pattern](../design-patterns/) — secondary adapters GoF Adapter pattern-in tətbiqidir

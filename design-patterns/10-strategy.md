...
## Əlaqəli Mövzular
- [03-factory-method.md](03-factory-method.md) — Strategy seçimi üçün Factory istifadə olunur
- [07-adapter.md](07-adapter.md) — Adapter interface uyğunlaşdırır, Strategy alqoritm dəyişdirir
- [11-command.md](11-command.md) — Command əməliyyatı encapsulate edir, Strategy alqoritmi dəyişdirir

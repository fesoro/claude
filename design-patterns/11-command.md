...
## Əlaqəli Mövzular
- [02-factory-method.md](02-factory-method.md) — Command object-lərinin yaradılması
- [10-observer.md](10-observer.md) — Command icrasından sonra event fire etmək
- [15-service-layer.md](15-service-layer.md) — Handler-ın Receiver rolu Service Layer-lə üst-üstə düşür
- [16-event-listener.md](16-event-listener.md) — Laravel Jobs ilə müqayisə

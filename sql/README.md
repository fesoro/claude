...
**Toplam: 95 mövzu** — sadədən mürəkkəbə doğru sıralanıb. Fayl nömrələri level-ə görə artır.
...
### Yeni Gələn — Middle Əlavələri

80. [Database Normalization (dərin)](80-database-normalization.md)
81. [NoSQL vs SQL — Müqayisə](81-nosql-vs-sql.md)
82. [N+1 Problem (praktik)](82-n-plus-one-problem.md)
83. [ORM Deep Dive](83-orm-deep-dive.md)
87. [Database Transactions (praktik)](87-database-transactions.md)

---

## ⭐⭐⭐ Senior (58–77 + 84–91) — Senior Səviyyə
...
### Yeni Gələn — Senior Əlavələri

79. [MySQL vs PostgreSQL — Dərin Müqayisə](79-mysql-vs-postgresql.md)
84. [Full-Text Search (PostgreSQL, MySQL, Elasticsearch)](84-full-text-search.md)
85. [Database Replication — Praktik](85-database-replication.md)
86. [Database Indexing — Dərin](86-database-indexing.md)
88. [Query Optimization — Praktik](88-query-optimization.md)
89. [Slow Query Profiling (EXPLAIN ANALYZE, pt-query-digest)](89-slow-query-profiling.md)
90. [Database Partitioning](90-database-partitioning.md)
91. [Connection Pooling — Praktik](91-connection-pooling.md)

---

## ⭐⭐⭐⭐ Lead (78 + 92–95) — Staff / Principal Səviyyə

78. [NewSQL & Distributed SQL (CockroachDB, Spanner, TiDB, YugabyteDB)](78-newsql-distributed-sql.md)
92. [Zero-Downtime Migrations](92-zero-downtime-migrations.md)
93. [Database Sharding — Praktik](93-database-sharding.md)
94. [Materialized View — Praktik](94-materialized-view.md)
95. [Vector Databases (pgvector, Pinecone, Weaviate, Qdrant, Milvus)](95-vector-databases.md)
...
Bütün **Senior (58-77, 79, 84-91)** + **Lead (78, 92-95)** + kənar materiallar (Designing Data-Intensive Applications, PostgreSQL Internals).

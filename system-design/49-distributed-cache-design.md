# Distributed Cache Design (Senior)
...
Redis single-node-da yaddaş limitinə çatır; cluster rejimindəki consistent hashing, replication, eviction strategiyası production-da kritik problemlər yaradır. Hot key problemi cache-i bottleneck edir. Memcached vs Redis vs Dragonfly — seçim use-case-ə görədir.
...
- [Caching Strategies](03-caching-strategies.md) — cache pattern-ləri əsası
- [Data Partitioning](26-data-partitioning.md) — cache cluster şardlama
- [Probabilistic Data Structures](33-probabilistic-data-structures.md) — cache miss azaltmaq
- [KV Store Design](50-key-value-store-design.md) — cache-in arxitektura variantı
- [Sharded Counters](88-sharded-counters.md) — Redis hot key problemi həlli

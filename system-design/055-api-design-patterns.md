...
REST, gRPC, GraphQL, WebSocket — hər biri fərqli use-case üçündür. Yanlış seçim developer experience-i pisləşdirir, performance problem yaradır. API versioning strategiyası breaking change-ləri necə idarə etmək lazım olduğunu müəyyən edir. Senior developer bu seçimləri əsaslandıra bilməlidir.
...
- [API Gateway](02-api-gateway.md) — API-ləri idarə edən qat
- [Auth](14-authentication-authorization.md) — API security
- [Real-Time Systems](17-real-time-systems.md) — WebSocket API
- [Microservices](10-microservices.md) — servislərarası API dizaynı
- [Webhook Delivery](82-webhook-delivery-system.md) — push-based API pattern

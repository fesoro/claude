...
## Mündəricat
1. [N-Tier nədir?](#n-tier-nədir)
2. [2-Tier](#2-tier)
3. [3-Tier](#3-tier)
4. [4-Tier və N-Tier](#4-tier-və-n-tier)
5. [Fiziki vs Məntiqi Tier](#fiziki-vs-məntiqi-tier)
6. [PHP Deployment Nümunəsi](#php-deployment-nümunəsi)
7. [Layered Architecture ilə fərqi](#layered-architecture-ilə-fərqi)
